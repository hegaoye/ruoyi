...
create table sys_dept (
  ...
  primary key (dept_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=200 comment = '部门表';
...
create table sys_user (
  ...
  primary key (user_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '用户信息表';
...
(
  ...
  remark        varchar(500)    default null               comment '备注',
  primary key (post_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   comment = '岗位信息表';
...
create table sys_role (
  ...
  remark            varchar(500)    default null               comment '备注',
  primary key (role_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '角色信息表';
...
create table sys_menu (
  ...
  primary key (menu_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=2000 comment = '菜单权限表';
...
create table sys_oper_log (
  ...
  primary key (oper_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '操作日志记录';
...
(
  ...
  primary key (dict_id),
  unique (dict_type)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '字典类型表';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '字典数据表';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '参数配置表';
...
create table sys_logininfor (
  ...
  primary key (info_id)
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '系统访问记录';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=100 comment = '定时任务调度表';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=10 comment = '通知公告表';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=1 comment = '代码生成业务表';
...
) engine=innodb CHARACTER SET = utf8mb4  COLLATE = utf8mb4_general_ci   auto_increment=1 comment = '代码生成业务表字段';